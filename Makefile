...
# Targets
TEST_BINS = naivetest indextest m1test m2test m3test reset draw_bboxes draw_3 curvetest query_gen goodtest query_gen_clus make_ug curvetest2 sample sample2 curvetest2
